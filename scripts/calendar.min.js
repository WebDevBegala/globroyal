var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.createTemplateTagFirstArg=function(a){return a.raw=a};$jscomp.createTemplateTagFirstArgWithRaw=function(a,c){a.raw=c;return a};var gameTypes="B2 B3 B4 B5 B6 B7 D1 D2".split(" "),daysName="Vas\u00e1rnap H\u00e9tf\u0151 Kedd Szerda Cs\u00fct\u00f6rt\u00f6k P\u00e9ntek Szombat".split(" "),gHours=[],allDays=[],freeDays=[],date,gDay;function accepted(){$(".footer-blocking").hide();$(".footer").hide()}
$(document).ready(function(){bookingDate=date;var a=new Date,c=a.getFullYear(),b=a.getMonth();a.getDate();a=9<b?b+1:"0"+(b+1);$("#currentDate").text(c+"-"+a);renderDays(c,b)});Date.prototype.addDays=function(a){var c=new Date(this.valueOf());c.setDate(c.getDate()+a);return c};
function renderDays(a,c){$(".calendar-content");$(".calendar-content").html("");for(var b=new Date,d=0;15>d;d++){var e=b.addDays(d),g=void 0==daysName[e.getDay()]?"H\u00e9tf\u0151":daysName[e.getDay()],h=9>e.getMonth()?"0"+Number(e.getMonth()+1):Number(e.getMonth()+1),k=9>e.getDate()?"0"+e.getDate():e.getDate();$(".calendar-content").append('\n    <div class="c-block" onclick="selectDay('+e.getDate()+')" ><p style="margin:0.5em" >'+h+"."+k+"</br>"+g+"</p></div>\n    ")}}
var selectDay=function(a){gDay=a;var c=new Date,b=c.getFullYear(),d=9>c.getMonth()?"0"+(c.getMonth()+1):c.getMonth()+1;date=b+"-"+d+"-"+(9>a?"0"+a:a);$(".calendar-content").html("");$(".calendar-content").addClass("calendar-times").removeClass("calendar-content");getFreePos(date);getOpenHours(date);$("#currentDate").text(date)};
...
function back(){var a=new Date,c=a.getFullYear(),b=a.getMonth();a.getDate();$(".calendar-times").html("");$(".calendar-times").addClass("calendar-content").removeClass("calendar-times");renderDays(c,b)}
