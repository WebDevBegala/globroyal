...
function renderDays(a,c){$(".calendar-content");$(".calendar-content").html("");for(var b=new Date,d=0;15>d;d++){var e=b.addDays(d),g=void 0==daysName[e.getDay()]?"H\u00e9tf\u0151":daysName[e.getDay()],h=9>e.getMonth()?"0"+e.getMonth():e.getMonth(),k=9>e.getDate()?"0"+e.getDate():e.getDate();$(".calendar-content").append('\n    <div class="c-block" onclick="selectDay('+e.getDate()+')" ><p style="margin:0.5em" >'+h+"."+k+"</br>"+g+"</p></div>\n    ")}}
